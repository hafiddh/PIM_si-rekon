    ...
    <nav class="sidenav navbar navbar-vertical fixed-left navbar-expand-xs navbar-light bg-white" id="sidenav-main">
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header d-flex align-items-center">
                <a class="navbar-brand" href="{{ url('/keuangan') }}">
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link @yield('side_dash')" href="{{ url('keuangan') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('side_kel')" href="{{ url('keuangan/data_masuk') }}">
                                <i class="ni ni-single-copy-04 text-pink"></i>
                                <span class="nav-link-text">Data Rekon Masuk</span>
                            </a>
                        </li>
                        ...
                        {{-- <li class="nav-item">
                            ...
                            <div class="collapse @yield('side_kel2')" id="navbar-forms">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ url('keuangan/data_masuk') }}"
                                            class="nav-link @yield('side_dama')">Data Masuk</a>
                                    </li>
                                </ul>
                            </div>
                        </li> --}}
                    ...
                    <ul class="navbar-nav mb-md-3">
                        <li class="nav-item">
                            <a class="nav-link"
                            href="{{ asset('') }}uploads/panduan_keu.pdf"
                                target="_blank">
                            ...
                            <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right py-0 overflow-hidden">
                                ...
                                @foreach ($notif as $notif)
                                    <div id="notif" class="list-group list-group-flush">
                                        <a href="{{ url('keuangan/kill_notif/'. $notif->id)}}"
